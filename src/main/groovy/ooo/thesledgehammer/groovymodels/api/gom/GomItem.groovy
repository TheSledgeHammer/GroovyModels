...
import ooo.thesledgehammer.groovymodels.api.gom.interfaces.IGomItem
import ooo.thesledgehammer.groovymodels.api.gom.interfaces.IGomTRSR

class GomItem extends Gom implements IGomItem, IGomElements, IGomTRSR {

    GomItem() {
        super();
    }

    GomItem(String mType) {
        super(mType);
    }

    GomItem(String mPath, String mType) {
        super(mPath, mType);
    }

    GomItem(String mPath, String mVersion, String mType) {
