...
import ooo.thesledgehammer.groovymodels.api.gom.interfaces.ISGomReader
import ooo.thesledgehammer.groovymodels.api.gom.interfaces.ISGomWriter
import ooo.thesledgehammer.groovymodels.config.Constants

class SuperGom {

    static String CURRENT_VERSION = Constants.GOM_VERSION
    static String PATH = Constants.SUPER_GOM_PATH;
    ...
    static class Serializer implements ISGomReader, ISGomWriter {
